<%@ Page Language="C#" AutoEventWireup="true" CodeFile="A_otpverify.aspx.cs" Inherits="Admin_A_otpverify" %>
...
<body>
   <div class="login-container d-flex ">
       <form class="login-form text-center " runat="server">
           <h3 class="mb-5">Otp Verify </h3>
            <div class="form-group ">
                <asp:TextBox ID="txtotp" CssClass="form-control rounded-pill mb-5 form-control-lg" runat="server" placeholder="Enter the OTP"></asp:TextBox>
            </div>
           
               <asp:Button ID="btnverify" CssClass="btn btn-custum btn-block text-uppercase rounded-pill btn-lg mb-4" runat="server" Text="VERIFY"   />
